...
class EcomBackendApplicationTests {
	...
	// @Test
	// void contextLoads() {
	// // This test method checks if the Spring application context loads
	// successfully.
	// // It is annotated with @Test, indicating that it is a JUnit test method.
	// // If the context fails to load, the test will fail, indicating a problem
	// with the application's configuration.
	// // This is a basic sanity check to ensure that all the beans and dependencies
